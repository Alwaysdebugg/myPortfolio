...
export default function SplashScreen({ onDragDown }: SplashScreenProps) {
  ...
  return (
    <motion.section
      className="min-h-screen bg-white dark:bg-black flex flex-col items-center justify-center relative overflow-hidden cursor-grab active:cursor-grabbing"
      drag="y"
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="flex items-center justify-center gap-4 text-black dark:text-white font-serif flex-wrap">
        ...
        >
          <span className="text-gray-600 dark:text-gray-400 font-serif text-xl mr-4">
            Jacky Feng
          </span>
          <motion.a
      ...
      >
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            >
              <div className="w-8 h-1 bg-gray-500 dark:bg-gray-400 rounded-full"></div>
              <div className="w-6 h-1 bg-gray-500 dark:bg-gray-400 rounded-full"></div>
              <div className="w-4 h-1 bg-gray-500 dark:bg-gray-400 rounded-full"></div>
            </motion.div>
